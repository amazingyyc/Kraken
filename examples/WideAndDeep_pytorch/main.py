...
# with torch.autograd.profiler.profile(enabled=True, use_cuda=False, record_shapes=True, profile_memory=False) as prof:
for epoch in range(n_epochs):
  ...
  for i, (X_wide, X_deep, target) in enumerate(train_loader):
    ...
    print('Avg duration:', total_duration / count)

# prof.export_chrome_trace('./perf.json')
